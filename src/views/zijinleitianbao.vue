<template>
    <div class="zhenti">
     ...
     <el-select class="riqi" v-model="value2" placeholder="项目级别">
      <el-option
  ...
  <el-select class="ddd" v-model="value2" placeholder="主管科室">
      <el-option
      v-for="item2 in options2"
      :key="item2.value"
      :label="item2.label"
  ...
  <el-select class="vvv" v-model="value2" placeholder="状态">
      <el-option
      v-for="item2 in options2"
      :key="item2.value"
      :label="item2.label"
...
<div class="erchen">
    <div class="skl">
  <el-select class="ggg" v-model="value2" placeholder="请选择日期范围">
      <el-option
      v-for="item2 in options2"
      :key="item2.value"
      :label="item2.label"
  ...
  <div class="sssss"><div><el-button type="primary">搜索</el-button></div><div><el-button>重置</el-button></div>  </div>
  </div>
        </div>
        <div class="dsaasd">
...
<el-button class="smm">通过</el-button>
<el-button class="smm">驳回</el-button>
<el-button class="smm">提交</el-button>
<el-button class="smm">导出</el-button>
</el-row>
